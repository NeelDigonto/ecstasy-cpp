...
ecstasy::app::app(std::string _app_name, std::uint32_t _window_width, std::uint32_t _window_height) {
    ...
    material->setDefaultParameter("baseColor", filament::RgbType::LINEAR, filament::math::float3{0, 1, 0});
...
ecstasy::EditorController* ecstasy::app::getEditorController() noexcept { return editor_controller_; }
